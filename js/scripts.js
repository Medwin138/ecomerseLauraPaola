			...
			<article class="detalle-grid">
				...
				<div class="detalles-content">
					...
					<div class="rating">
						...
						<p class="description">
							<b>Descripcion: </b> <span>Tener una camisa con estilo fresco en el armario es una regla básica que todo hombre debe seguir. Sin embargo, en repetidas ocasiones ocurre que no conseguimos que la camisa se adapte a nuestro cuerpo de la manera que esperamos, por lo que todos nuestros sueños de lucir galanes se van a la basura</span>
						</p>
						<p class="description">
